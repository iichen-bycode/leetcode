...
public class leetcode_2105 {
    public static void main(String[] args) {
        // plants = [2,2,3,3], capacityA = 5, capacityB = 5     1
        // plants = [2,2,3,3], capacityA = 3, capacityB = 4     2
//        plants = [5], capacityA = 10, capacityB = 8       0
        System.out.println(minimumRefill(new int[]{2, 2, 3, 3}, 5, 5));
        System.out.println(minimumRefill(new int[]{2, 2, 3, 3}, 3, 4));
        System.out.println(minimumRefill(new int[]{5}, 5, 3));
    ...
    public static int minimumRefill(int[] plants, int capacityA, int capacityB) {
        ...
        while(l <= r) {
            // 同一个植物
            if(l == r) {
                int c = Math.max(capacityA,capacityB);
                if(c < plants[l]) {
                    ans += 1;
                    return ans;
                }
